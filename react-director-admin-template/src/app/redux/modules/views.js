...
const ENTER_PIPELINE = 'ENTER_PIPELINE';
const LEAVE_PIPELINE = 'LEAVE_PIPELINE';
...
export function enterPipeline(time = moment().format()) {
  return {
    type:         ENTER_PIPELINE,
...
export function leavePipeline(time = moment().format()) {
  return {
    type:         LEAVE_PIPELINE,
    currentView:  'Pipeline',
    enterTime:    null,
